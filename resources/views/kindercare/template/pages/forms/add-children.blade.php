...
<body>
            ...
            <div class="col-7 grid-margin stretch-card">
              <div class="card">
                ...
                <!-- Add a search input field for guardian name -->
                    ...
                    <div class="form-group">
                        <label for="my_kid_number">My Kid Number</label>
  ...
  <script>
        ...
        if (data.length > 0) {
          data.forEach(guardian => {
            ...
            guardianDiv.innerHTML = `
              <p>${guardian.name} - <button onclick="selectGuardian(${guardian.id})">Select</button></p>
            `;
    ...
    function selectGuardian(guardianId) {
      ...
      document.getElementById('guardian-results').innerHTML = `<p>Guardian selected with ID: ${guardianId}</p>`;
    }
